...
Access keys are bearer credentials. Do not commit them, include them in screenshots, or paste them into issues and pull requests. Store them in an MCP client's secret store or an environment variable.
